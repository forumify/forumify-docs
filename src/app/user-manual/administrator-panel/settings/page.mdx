...
<Alert severity="info">
	Recommended image format is .png, size is 64x64px, resolution is 300pp and blank background. Supported formats are .png & .jpg.
...
Create a role here. You can set it administrator or moderator. The specific permissions will be set trough the forums settings directly. For now you can not link a badge to a role.
