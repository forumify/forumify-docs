...
<div className="flex gap-2 box w-30">
...
<div className="flex gap-2 items-center">
    <div className="text-center">
        <button class="btn-primary"><i><CaretDown/></i></button>
        ```
        <button class="btn-primary">Icon</button>
        ```
    </div>
    <div className="text-center">
        <button class="btn-primary btn-icon"><i><CaretDown/></i></button>
        ```
        <button class="btn-primary btn-icon">Icon</button>
        ```
    </div>
</div>
