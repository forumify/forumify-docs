...
**Note:** In this documentation, we utilise the ``border`` component to show the grid property. By default,
...
<div className="grid-xs-1 grid-s-2 grid-md-4 grid-lg-6">
    <div className="border">col-1</div>
    <div className="border">col-2</div>
    <div className="border">col-3</div>
    <div className="border">col-4</div>
...
```
<div class="grid-s-2 grid-md-4 grid-lg-6">
    <div>col-1</div>
    <div>col-2</div>
    <div>col-3</div>
    <div>col-4</div>
...
*2 columns on mobile, 4 columns on tablet, 6 columns on desktop.*
