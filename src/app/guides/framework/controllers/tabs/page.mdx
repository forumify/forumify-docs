...
{% endembed %}
```
If you need this flexibility, you can write your own twig skeleton and apply the stimulus controller and targets manually. 
See [tabs component](https://github.com/forumify/forumify-platform/blob/master/templates/components/tabs.html.twig).
