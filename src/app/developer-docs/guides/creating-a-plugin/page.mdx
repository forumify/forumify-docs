...
<Alert severity="info">
    ...
    See the <Link href="/developer-docs/guides/customization/introduction">Customization Introduction Guide</Link> to learn about running a local forumify instance.
</Alert>
